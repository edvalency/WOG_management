...
// Class definition
var RevnExp = function () {
    // Private methods
    var initChart = function() {
        var element = document.getElementById("revnexp_chart");
...
var KTCardsWidget1 = function () {
    ...
    var initChart = function() {
        ...
        var options = {
            series: [{
                name: ['Sales','2','3','4','5','6'],
                data: [30, 75, 55, 45, 30, 60, 75, 50,22,45,65,10],
                margin: {
					left: 5,
					right: 5
				}
