...
var KTWidgets = function () {
    ...
    var initDaterangepicker = function () {
        if (!document.querySelector('#kt_dashboards_daterangepicker')) {
            return;
        }

        var picker = $('#kt_dashboards_daterangepicker');
        var start = moment();
        var end = moment();
        ...
        function cb(start, end, label) {
            ...
            $('#kt_dashboards_daterangepicker_date').html(range);
            $('#kt_dashboards_daterangepicker_title').html(title);
        }
