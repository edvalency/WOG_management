...
@section('content')
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            ...
            <div class="card card-flush mt-6 mt-xl-9">
                <div class="d-flex justify-content-end align-items-end flex-wrap mb-2 mt-4"> <a
                        data-bs-target="#add_tithe_modal"
                        class="btn btn-sm btn-bg-primary text-white btn-active-color-primary me-3" data-bs-toggle="modal">Record
                        tithe</a>
                </div>
                <!--begin::Card header-->
                <div class="card-header mt-2">
                    ...
                    <div class="card-title flex-column">
                        <h3 class="fw-bold mb-1">Tithes</h3>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="#"
                                                        class="fs-6 text-gray-800 text-hover-primary">{{ $tithe->fullname }}</a>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <!--end::User-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('tithe.edit', $tithe->id) }}" class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('tithe.delete',$tithe->id)}}" onclick="return confirm('Confirm you want to delete?')" class="menu-link px-3"
                                                        >Delete</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
    ...
    <!--end::Content-->
    @include('includes.modals.add-tithe')
