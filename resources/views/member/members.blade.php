                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-5">
                        <div class="row justify-content-end">
                          ...
                          data-target="#importDataModal">Import Members</button>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info mt-2"
                                                    href="{{ route('mem.single', $value->mask) }}">Details</a> | <a
                                                    class="btn btn-warning mt-2"
                                                    href="{{ route('attendance.mark', $value->mask) }}">Mark as present</a>
                                                | <a class="btn btn-secondary mt-2"
                                                    href="{{ route('attendance.unmark', $value->mask) }}">Unmark as
                                                    present</a></td>
                                        </tr>
                                    @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Import Members</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="" action='{{ route('members.import') }}' enctype="multipart/form-data"
                        method="post">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" class="form-control" placeholder="amount" name="file">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-success m-t-15 waves-effect">Import</button>
                    </form>
                </div>
            </div>
        </div>
