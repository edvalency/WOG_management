        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3">
                    <!--begin::Menu- wrapper-->
                    @php
                        $thisweek = json_decode(session()->get('bdays', 'default'));
                    @endphp
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-secondary w-60px h-30px w-md-60px h-md-40px"
                        data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
                        <i class="fa-solid fa-cake-candles fs-2 fs-lg-1"></i>
                        <span class="badge badge-circle badge-danger ms-2">{{ count($thisweek) }}</span>
                    </div>
                    <!--begin::Menu-->
                            ...
                            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                <li class="nav-item">
                                    <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4 active"
                                        data-bs-toggle="tab" href="#kt_topbar_notifications_1">This week</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4"
                                        data-bs-toggle="tab" href="#kt_topbar_notifications_2">Next Week</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-dark opacity-75 opacity-state-100 pb-4"
                                        data-bs-toggle="tab" href="#kt_topbar_notifications_3">Next two Weeks</a>
                                </li>
                            </ul>
                            <!--end::Tabs-->
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    @foreach ($thisweek as $member)
                                        <!--begin::Item-->
                                        @php
                                        $now = \Carbon\Carbon::now();
                                        $currbday = \Carbon\Carbon::parse($member->dob)->year($now->year);

                                        $diff = \Carbon\Carbon::parse($currbday)->diffInDays();
                                        ...
                                        <div class="d-flex flex-stack py-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mb-0 me-2">
                                                    <a href="#"
                                                        class="fs-6 text-gray-800 text-hover-primary fw-bold">{{ $member->fullname }}</a>
                                                    <div class="text-gray-400 fs-7">{{ date('D, jS M Y', strtotime($member->dob)) }}</div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Section-->
                                            <!--begin::Label-->
                                            <span class="badge badge-light fs-8"> {{ $diff == 0 ? 'Today' :"In $diff days"  }}</span>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    @endforeach
                                ...
                                {{-- <div class="py-3 text-center border-top">
                                    <a href="/pages/user-profile/activity"
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-5">
                            <a href="/account/overview" class="menu-link px-5">My Profile</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/account/referrals" class="menu-link px-5">Referrals</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/account/billing" class="menu-link px-5">Billing</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/account/statements" class="menu-link px-5">Payments</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/account/statements" class="menu-link d-flex flex-stack px-5">Statements
