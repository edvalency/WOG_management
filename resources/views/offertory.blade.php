                                        ...
                                        <tbody id='offertorylist'>
                                            ...
                                            @foreach ($data as $key=>$value)
                                                <tr>
                                                  ...
                                                  <td>{{ $value->amount }}</td>
                                                  <td><a href="{{route('offertory.delete', $value->id)}}" class="btn btn-danger" onclick="return confirm('confirming offertory delete?')">Delete record</a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" action='{{ route('offertory.save') }}' method="post">
                        @csrf
